...
static inline
double check_ver(SDL_Surface *img, int start_y, int center_x, int state_2,\
        int totalsize)
{
    int h = img->h;
    int state_check[5] = {0};
    ...
    while((y >= 0) && (get_BW(img, center_x, y) == 1) && (state_check[1] <\
                state_2))
    {
        state_check[1]++ ;
        y--;
    ...
    while((y >= 0) && (get_BW(img, center_x, y) == 0) && (state_check[0] <\
                state_2))
    {
        state_check[0]++ ;
        y--;
    ...
    while((y <= h) && (get_BW(img, center_x, y) == 1) && (state_check[3] <\
                state_2))
    {
        state_check[3]++ ;
        y++;
    ...
    while((y <= h) && (get_BW(img, center_x, y) == 0) && (state_check[4] <\
                state_2))
    {
        state_check[4]++ ;
        y++;
...
static inline
double check_hor(SDL_Surface *img, int center_y, int start_x, int state_2,\
        int totalsize)
{
    int w = img->w;
    int state_check[5] = {0};
    ...
    while((x >= 0) && (get_BW(img, x, center_y) == 1) && (state_check[1] <\
                state_2))
    {
        state_check[1]++ ;
        x--;
    ...
    while((x >= 0) && (get_BW(img, x, center_y) == 0) && (state_check[0] <\
                state_2))
    {
        state_check[0]++ ;
        x--;
    ...
    while((x <= w) && (get_BW(img, x, center_y) == 1) && (state_check[3] <\
                state_2))
    {
        state_check[3]++ ;
        x++;
    ...
    while((x <= w) && (get_BW(img, x, center_y) == 0) && (state_check[4] <\
                state_2))
    {
        state_check[4]++ ;
        x++;
...
static inline
double check_diag(SDL_Surface *img, int center_y, int center_x, int state_2,\
        int totalsize)
{
    int state_check[5] = {0};
    ...
    while((center_y >= i) && (center_x >= i) && (get_BW(img, center_x - i,\
                    center_y - i) == 0))
    {
        state_check[2]++ ;
        i++;
    ...
    while((center_y >= i) && (center_x >= i) && (get_BW(img, center_x - i,\
                    center_y - i) == 1) && (state_check[1] <= state_2))
    {
        state_check[1]++ ;
        i++;
    }
    ...
    while((center_y >= i) && (center_x >= i) && (get_BW(img, center_x - i,\
                    center_y - i) == 0) && (state_check[0] <= state_2))
    {
        state_check[0]++ ;
        i++;
    }
    ...
    while(((center_y + i) < h) && (center_x+1) < w && (get_BW(img,\
    ...
    while(((center_y + i) < h) && ((center_x + i) < w) && (get_BW(img, \
                    center_x + i, center_y + i) == 1) &&\
            (state_check[3] < state_2))
    {
        state_check[3]++ ;
        i++;
    }
                ...
                else
                {
                    if(state_count == 4)
                    {
                        ...
                        if(totalsize >= 1)
                        {
                            ...
                            handle_centers(img, centers, state, y, x, \
                                    ems_vector, totalsize);
                            //warn("out");
                        }
                        else
                        {
